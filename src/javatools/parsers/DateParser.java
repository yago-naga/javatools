...
public class DateParser {
	...
	private static final FindReplace[] patterns = new FindReplace[] {
			...
			new FindReplace(newDate("([0-9#]++)", "([0-9])", "([0-9\\#]++)"), newDate("$1", "0$2", "$3")), new FindReplace(newDate("([0-9#]++)", "([0-9#]{2})", "([0-9])" + WB), newDate("$1", "$2", "0$3")) };

	/** Holds the pattern seeking for month names */
	private static final Pattern monthPattern = Pattern.compile(WB + "(Jan|January|Feb|February|Febr|Mar|March|Apr|April|May|Jun|June|Jul|July|Aug|August|Sep|September|Sept"
			+ "|Oct|October|Nov|November|Dec|December)" + WB);

	private static final Pattern monthPatternEn = Pattern.compile(WB + "(Jan|January|Feb|February|Febr|Mar|March|Apr|April|May|Jun|June|Jul|July|Aug|August|Sep|September|Sept"
			+ "|Oct|October|Nov|November|Dec|December)" + WB);

	private static final Pattern monthPatternDe = Pattern.compile(WB + "(Jan|Januar|Feb|Februar|Febr|M\u00E4r|M\u00E4rz|Apr|April|Mai|Jun|Juni|Jul|Juli|Aug|August|Sep|September|Sept"
			+ "|Okt|Oktober|Nov|November|Dez|Dezember)" + WB);

	private static final Pattern monthPatternEs = Pattern.compile(WB + "(ene|enero|feb|febrero|febr|mar|marzo|abr|abril|may|mayo|jun|junio|julio|ago|agosto|sep|septiembre"
			+ "|oct|octubre|nov|noviembre|dic|diciembre)" + WB);

	private static final Pattern monthPatternFr = Pattern.compile(WB + "(janv|janvier|f\u00E9vr|f\u00E9vrier|mars|avr|avril|mai|juin|juil|juillet|ao\u00FBt|sept|septembre"
			+ "|oct|octobre|nov|novembre|d\u00E9c|d\u00E9cembre)" + WB);

	private static final Pattern monthPatternIt = Pattern.compile(WB + "(gen|gennaio|feb|febbraio|febr|mar|marzo|apr|aprile|mag|maggio|giu|giugno|lug|luglio|ago|agosto|set|settembre"
