...
public class Char17 {
  ...
  public static IntHashMap<String> ampersandMap = new IntHashMap<String>().putAll("nbsp", (char) 160, "iexcl", (char) 161, "cent", (char) 162,
  ...
  public static String decodeAmpersand(String string) {
    ...
    for (int i = 0; i < string.length(); i++) {
      ...
      int end = i;
      while (end < string.length() && !Character.isSpaceChar(string.charAt(end)) && string.charAt(end) != ';')
        end++;
    ...
    for (int i = 0; i < string.length(); i++) {
      ...
      if (string.length() - i >= len) switch (len) {
        ...
        case 4:
          ...
          result.append((char) (((string.charAt(i + 0) & 0x07) << 18) + ((string.charAt(i + 1) & 0x3F) << 12) + ((string.charAt(i + 2) & 0x3F) << 6)
  ...
  public static String decodeBackslash(String string) {
    ...
    for (int i = 0; i < string.length(); i++) {
      ...
      switch (nextChar) {
        ...
        case '7': // Octal codes
          int end = i + 1;
          while (end < string.length() && string.charAt(end) >= '0' && string.charAt(end) <= '8')
            end++;
          try {
