...
public class Name {
  ...
  public static final String familyNameSuffix = "(?:" + "CBE|" + // Commander
      ...
      "[jJ]r\\.?|" + "[jJ]unior|" + "hijo|" + "hija|" + "P[hH]\\.?[dD]\\.?|" + "KBE|" + // Knight or Dame Commander
      "MBE|" + // Member
      "M\\.?D\\.|" + "OBE|" + // Officer
      "[sS]enior|" + "[sS]r\\.?)";
  ...
  public static final String title = "\\b(?:" + "[aA]dmiral\\b|" + "[aA]mbassador\\b|" + "[bB]ishop\\b|" + "[bB]brother\\b|" + "[cC]aptain\\b|" +
      ...
      "[gG]gouverneur\\b|" + "[gG]ov\\.\\b|" + "[gG]overnor\\b|" + "[hH]onorable\\b|" + "[hH]onourable\\b|" + "[jJ]udge\\b|" + "[kK]ing\\b|"
      + "[lL]ady\\b|" + "[lL]ieutenant\\b|" + "[lL]ieutenant [gG]overnor\\b|" + "[lL]ord\\b|" + "[mM]aj\\.|" + "[mM]ajor\\b|" + "[mM]aster\\b|"
      + "[mM]essrs\\.?|" + "[mM]iss\\b|" + "[mM]rs?\\.|" + "[mM]rs?\\b|" + "[mM]s\\.|" + "[mM]s\\b|" + "[pP]ope\\b|" + "[pP][hH]\\.?[dD]\\b|"
      + "[pP]resident\\b|" + "[pP]rof\\.?|" + "[pP]rofessor\\b|" + "[pP]rince\\b|" + "[pP]rincess\\b|" + "[rR]abbi\\b|" + "[rR]evd?\\.|"
      + "[rR]everend\\b|" + "[qQ]ueen\\b|" + "[sS]aint\\b|" + "[sS]t\\.|" + "[sS]t\\b|" + "[sS]ecretary\\b|" + "[sS]enator\\b|" + "[sS]ergeant\\b|"
      + "[sS]ir\\b|" + "[sS]ister\\b|" + "[sS]ultan\\b|" + "[eE]mperor\\b|" + "[eE]mpress)";
  ...
  public static Set<String> titlesForGivenNames = new FinalSet<String>("brother", "father", "king", "lady", "pope", "prince", "princess", "queen",
      "sister", "sultan", "emperor", "empress", "st", "st.");
  ...
  public static final String companyNameSuffix = "(?:" + "[cC][oO]\\.|" + "[cC][oO]\\b|" + "&" + B + "?[cC][oO]\\.|" + "&" + B + "?[cC][oO]\\b|"
      + "\\b[cC][oO][rR][pP]\\.|" + "\\b[cC][oO][rR][pP]\\b|" + "\\b[cC]orporation\\b|" + "\\b[iI][nN][cC]\\.|" + "\\b[iI][nN][cC]\\b|"
      + "\\b[iI]ncorporated\\b|" + "\\b[iI]ncorporation\\b|" + "\\b[iI]ncorp\\.?|" + "\\b[iI]ncorp\\b|" + "\\b[lL][tT][dD]\\.|"
      + "\\b[lL][tT][dD]\\b|" + "\\b[lL]imited\\b)";
  ...
  public static final Pattern laxPersonNamePattern = Pattern
      .compile(c(optMul(title + B)) + c(optMul(givenName + B)) + opt(c(nickName) + B) + opt(c(attributePrefix) + B) + opt(c(familyNamePrefix) + B)
          + c(familyName) + opt(BC + c(familyNameSuffix)) + opt(B + c(roman)) + opt(B + of + B + c(personNameComponent)) + opt(B + c(nickName)));
  ...
  public static class PersonName extends Name {
    ...
    public String familyNameWithAffixes() {
      ...
      return (myFamilyNamePrefix == null ? "" : myFamilyNamePrefix + " ") + myFamilyName
          + (myFamilyNameSuffix == null ? "" : " " + myFamilyNameSuffix);
    }
  ...
  public static Map<String, String> languageCodes = new FinalMap<String, String>("aa", "Afar", "ab", "Abkhazian", "ae", "Avestan", "af", "Afrikaans",
      ...
      "Volap�k", "wa", "Walloon", "wo", "Wolof", "xh", "Xhosa", "yi", "Yiddish", "yo", "Yoruba", "za", "Zhuang", "zh", "Chinese", "zu", "Zulu");
